...
$sql_cvid="select * from applicant where id=$id";
$res1=$con->query($sql_cvid);
$app_record=$res1->fetch_assoc();
$cvid = $app_record['cvid'];


$sql_cvinfo="select * from cvfile where id=$cvid";
$res2=$con->query($sql_cvinfo);
$cv_record=$res2->fetch_assoc();
$res_eduinfo=$cv_record['educationInfo'];
$res_expinfo=$cv_record['experienceInfo'];
$res_skills=$cv_record['skills'];
$res_languages=$cv_record['languages'];
$res_contact=$cv_record['contact'];
$res_email=$cv_record['email'];
...
<label class="control-label">Education Info: </label> 
 <textarea rows="6"  name="eduinfo"  class="form-control" > <?php echo (isset($_POST['eduinfo']))?$_POST['eduinfo']:$res_eduinfo;?> </textarea> 
</div>
</div>
<div class="row">
<div class="col-lg-8 form-group">
<label class="control-label">Experience Info: </label>
 <textarea rows="6" name="expinfo"  class="form-control" > <?php echo (isset($_POST['expinfo']))?$_POST['expinfo']:$res_expinfo;?> </textarea> 
</div>
</div>
<div class="row">
<div class="col-lg-8 form-group">
<label class="control-label">Contact: </label>
 <input type="text" name="contact" value="<?php echo (isset($_POST['contact']))?$_POST['contact']:$res_contact;?>" class="form-control" />
</div>
</div>
<div class="row">
<div class="col-lg-8 form-group">
<label class="control-label">Email: </label>
 <input type="text" name="email" value="<?php echo (isset($_POST['email']))?$_POST['email']:$res_email;?>" class="form-control" />
</div>
</div>
<div class="row">
<div class="col-lg-8 form-group">
...
<div class="chkboxcontainer">
 ...
 <input type="text" value="<?php echo (isset($_POST['skills']))?$_POST['skills']:$res_skills;?>" id="skillsinput" name="skills"  class="form-control"  readonly/>
 </label>
 </div>
</div>
<div class="row">
...
<div class="chkboxcontainer">
 ...
 <input type="text" name="languages" value="<?php echo (isset($_POST['languages']))?$_POST['languages']:$res_languages;?>" id="langsinput"   class="form-control"  readonly/>
 </label>
 </div>
</div>
...
<br /><input type="submit" value="Update" name="updatesubmit" class="form-control" style="width:200px;"/>
</div>
</div>
</div>
</form>
