...
<div  >
<div class="col-lg-10 col-md-8 col-sm-8 col-xs-12" style="padding:0px;">
...
<p>
<a href="edit-post-details.php?id='<?php echo $record['id']; ?>'" target="_blank">edit</a>
<a href="manage-job-posts.php?id=<?php echo $record['id']; ?>" onclick="return confirm('are you sure you want to delete this record?')">delete</a>
</p>
</td>
</tr>
